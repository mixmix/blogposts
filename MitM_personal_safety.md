...
This is part of a series exploring the sociological and technological ramifications — I call it “The Medium is the Message: Cypherspace Edition”.
...
This got me wondering how our project [Scuttlebutt](https://www.scuttlebutt.nz) is any different from other decent hype.
Most pressing was the question “Can we guarantee to women or LGBTQI people that they will be safe from bullying and abuse?”.
...
On corporation run platforms like twitter, youtube, or facebook, there’s single central organisation with (essentially) a single data storage system.
...
Most platforms have a “report” or “flag” feature which marks content or users for review and/ or exclusion.
...
> # **There is no owner of any shared physical space/ hardware from which you can kick a person**.
...
In practice, what emerges is not that different to other networks — people migrate toward and away from conversations and people that they want to interact with.
We see ‘islands’ or ‘domains’ of community which might be distinct, might overlap, or might be totally disconnected.
It’s similar to the dynamics of Twitter, but while Twitters global space leaves it open for witch hunts and hashtag storms, Scuttlebutt is more localised and stable.
...
What we’ve built actually goes further by ceasing propagation of any of that persons data — this means friends of yours not already connected with this person won’t receive contact from them.
...
*Marshal McLuhan coined this [iconic phrase](https://en.wikipedia.org/wiki/The_medium_is_the_message), and I’d summarise it to roughly mean “the physics of your medium determine what is possible in that medium, and so ultimately the message”*.

Given Scuttlebutt is a cypherspace (a space whose foundation and physics are cryptography), what is the nature of the medium that is different here, *what is that message?*

The underlying cryptography is what makes it possible for people to be totally autonomous agents in this social network.
This affords a level of freedom from coercion of larger actors this affords is probably unprecedented in a digital space.
...
A recent example was finding a user who calls themselves “Johnny Null” in the *#dads* channel I’d started (I’m going to be a dad soon, and am talking about that with other crypto-dads).
